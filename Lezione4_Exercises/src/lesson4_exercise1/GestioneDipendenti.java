...
public class GestioneDipendenti {
	...
	public static void main(String[] args) {
		...
		arr[0] = marco;
		Dipendente alfredo = new Dipendente(343434, dipartimento.PRODUZIONE);
		arr[1] = alfredo;
		Dipendente chiara = new Dipendente(1200, 545454, 30, livello.IMPIEGATO, dipartimento.AMMINISTRAZIONE);
		arr[2] = chiara;
		Dipendente marina = new Dipendente(1500, 676767, 30, livello.QUADRO, dipartimento.VENDITE);
		arr[3] = marina;
		...
		while(true) {
			...
			case "stampa":{
				...
				break;				
					...
					// CALCOLA STIPENDIO TOTALE DIPENDENTI + 5 ORE DI STRA PER DIPENDENTE
			case "stipendi": {
				int somma = 0;
				for(int i = 0; i< arr.length; i++) {
				...
				break;	
					...
					// INFORMAZIONI CIRCA I COMANDI DA UTILIZZARE
			case "info":{
